...
import (
	...
	"github.com/LYH2263/go-gapbuf/internal/audit"
	"github.com/LYH2263/go-gapbuf/internal/clone"
	"github.com/LYH2263/go-gapbuf/internal/metrics"
	"github.com/LYH2263/go-gapbuf/internal/persist"
	"github.com/LYH2263/go-gapbuf/internal/validate"
)
...
type Engine struct {
	...
	relief  map[string]bool
}

func New(opts Options) (*Engine, error) {
	opts = opts.withDefaults()
	e := &Engine{opts: opts, items: make(map[string]*Record), relief: make(map[string]bool)}
	if opts.AuditPath != "" {
